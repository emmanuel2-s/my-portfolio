            ...
            <nav>
                <div className='text-white flex justify-between h-28 max-w-[1240px] mx-auto items-center px-4'>
                    ...
                    <ul className='ul hidden md:flex items-center'>
                        ...
                        <li className='px-7 font-medium text-lg hover:text-[#00df9a]'><a href=''>Skills</a></li>
                        <li className='px-7 font-medium text-lg hover:text-[#00df9a]'><a href=''>Portfolio</a></li>
                        <li className='px-7 font-medium text-lg hover:text-[#00df9a]'><a href=''>Contact</a></li>
                        <li className='px-7 font-medium text-lg hover:text-[#00df9a]'></li>
                    </ul>
                ...
                <div className={nav ? 'fixed md:hidden top-0 left-0 z-50 bg-[#000300] border-r border-r-gray-900 w-[300px] h-full ease-in-out delay-300 duration-500' : 'fixed left-[-100%]'}>
                    ...
                    <ul className='text-white p-4 uppercase'>
                        ...
                        <li className='p-4 border-b  hover:text-[#00df9a] border-b-gray-600 font-medium'><a href=''>Skills</a></li>
                        <li className='p-4 border-b  hover:text-[#00df9a] border-b-gray-600 font-medium'><a href=''>Portfolio</a></li>
                        <li className='p-4 font-medium hover:text-[#00df9a] '><a href=''>Contact</a></li>
